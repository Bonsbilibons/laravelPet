...
!function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).io = e()
        ...
        for (var b = {
            ...
            return w && o instanceof Blob ? e ? n(o) : O(o, n) : _ && (o instanceof ArrayBuffer || (r = o,
                "function" == typeof ArrayBuffer.isView ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer)) ? e ? n(o) : O(new Blob([o]), n) : n(m[i] + (o || ""))
        }, O = function(t, e) {
            ...
            return n.onload = function() {
                ...
                ,
                n.readAsDataURL(t)
        }, A = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", R = "undefined" == typeof Uint8Array ? [] : new Uint8Array(256), T = 0; T < A.length; T++)
            R[A.charCodeAt(T)] = T;
        ...
        var q = P.setTimeout
            , I = P.clearTimeout;
        function D(t, e) {
            e.useNativeTimers ? (t.setTimeoutFn = q.bind(P),
                t.clearTimeoutFn = I.bind(P)) : (t.setTimeoutFn = P.setTimeout.bind(P),
                t.clearTimeoutFn = P.clearTimeout.bind(P))
        }
        var F, M = function(t) {
            o(i, t);
            var n = p(i);
            ...
            return r(i, [{
                ...
                value: function(t, e, n) {
                    return y(s(i.prototype), "emitReserved", this).call(this, "error", new M(t,e,n)),
                        this
                }
            }, {
                key: "open",
            ...
            return r(i, [{
                ...
                value: function(t) {
                    if (void 0 !== this.xhr && null !== this.xhr) {
                        if (this.xhr.onreadystatechange = Z,
                            t)
                            try {
                                this.xhr.abort()
                            } catch (t) {}
            ...
            function a(n) {
                ...
                n && "object" === t(n) && (o = n,
                    ...
                    n ? (n = ft(n),
                        ...
                        o.port = n.port,
                    n.query && (o.query = n.query)) : o.host && (o.hostname = ft(o.host).host),
                    D(f(r), o),
        ...
        function bt(e, n) {
            ...
            if ("object" === t(e) && !(e instanceof Date)) {
                var s = {};
                for (var a in e)
                    Object.prototype.hasOwnProperty.call(e, a) && (s[a] = bt(e[a], n));
                return s
            }
            return e
        }
        function wt(t, e) {
            return t.data = _t(t.data, e),
        ...
        function _t(e, n) {
            ...
            if (Array.isArray(e))
                ...
                for (var i in e)
                    Object.prototype.hasOwnProperty.call(e, i) && (e[i] = _t(e[i], n));
            return e
        }
        var Et;
        !function(t) {
        ...
        var Ot = function() {
            ...
            return r(t, [{
                key: "encode",
                value: function(t) {
                    return t.type !== Et.EVENT && t.type !== Et.ACK || !mt(t) ? [this.encodeAsString(t)] : this.encodeAsBinary({
                ...
                value: function(t) {
                    var e = "" + t.type;
                    return t.type !== Et.BINARY_EVENT && t.type !== Et.BINARY_ACK || (e += t.attachments + "-"),
                    t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
                    null != t.id && (e += t.id),
            ...
            return r(a, [{
                ...
                value: function(t) {
                    ...
                    if ("string" == typeof t) {
                        ...
                        n || e.type === Et.BINARY_ACK ? (e.type = n ? Et.EVENT : Et.ACK,
                            this.reconstructor = new Rt(e),
                        0 === e.attachments && y(s(a.prototype), "emitReserved", this).call(this, "decoded", e)) : y(s(a.prototype), "emitReserved", this).call(this, "decoded", e)
                    } else {
                        if (!gt(t) && !t.base64)
        ...
        var Bt = Object.freeze({
            ...
            return r(a, [{
                ...
                value: function(t) {
                    ...
                    return c || (this.connected ? (this.notifyOutgoingListeners(i),
        ...
        var xt = function(n) {
            ...
            function s(n, r) {
                ...
                n && "object" === t(n) && (r = n,
                    ...
                    o.uri = n;
                var c = r.parser || Tt;
                return o.encoder = new c.Encoder,
            ...
            return r(s, [{
                ...
                value: function(t, e) {
                    var n = this.nsps[t];
                    return n || (n = new St(this,t,e),
                        this.nsps[t] = n),
                    this._autoConnect && n.connect(),
                        n
                }
            }, {
                key: "_destroy",
        ...
        function Pt(e, n) {
            ...
            return n.forceNew || n["force new connection"] || !1 === n.multiplex || c ? r = new xt(o,n) : (Lt[s] || (Lt[s] = new xt(o,n)),
                r = Lt[s]),
